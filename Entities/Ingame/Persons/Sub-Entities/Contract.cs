...
namespace FMScoutFramework.Core.Entities.InGame
{
    public class Contract : BaseObject, IContract
    {
        ...
        public ContractClause [] ContractClauses {
            get {
                Int64 numberOfClauses = ProcessManager.ReadArrayLength (MemoryAddress + ContractOffsets.Clauses, ContractClausesOffsets.ClauseLength);
        ...
        public ContractBonus [] ContractBonuses {
            get {
                Int64 numberOfBonuses = ProcessManager.ReadArrayLength (MemoryAddress + ContractOffsets.Bonuses, ContractBonusOffsets.BonusLength);
