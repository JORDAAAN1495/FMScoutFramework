...
{
    internal class Steam_22_0_1_1_Windows : IIVersion
    {
        ...
        public Steam_22_0_1_1_Windows(GameManager gm)
        {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context)
        {
            ...
            {
                if (process.VersionDescription != "22.0.1+1612687")
                {
                    return false;
                }
            }
            ...
            {
                process.VersionDescription = "22.0.1+1612687";
            }
            return true;
#endif
            #endregion
