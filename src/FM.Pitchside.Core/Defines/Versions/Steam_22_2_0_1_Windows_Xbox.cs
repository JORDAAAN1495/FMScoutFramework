...
{
    internal class Steam_22_2_0_1_Windows_Xbox : IIVersion
    {
        ...
        public Steam_22_2_0_1_Windows_Xbox(GameManager gm)
        {
        ...
        public string Description
        {
            get
            {
                return "22.2.0 (Windows Xbox / Microsoft Store)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context)
        {
            ...
            {
                if (process.VersionDescription != "22.2.0+1632745")
                {
                    return false;
                }
            }
            ...
            {
                process.VersionDescription = "22.2.0+1632745";
            }
            return true;
#endif
            #endregion
        ...
        {
            // Statics
            public Int64 MainAddress { get { return 0x4DBFC40; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x68; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x4CCB6D8; } } // BA ?? E5 07  At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x4DC0788; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
        ...
        {
            public Int64 Player { get { return 0x4792D98; } }         // UID: 3796
            public Int64 Staff { get { return 0x4790308; } }          // UID: 40
            public Int64 PlayerStaff { get { return 0x4794C88; } }    // UID: 103584
            public Int64 HumanManager { get { return 0x47A7EB8; } }     // UID: User Manager's
