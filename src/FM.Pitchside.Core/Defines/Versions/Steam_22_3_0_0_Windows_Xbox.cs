...
{
    internal class Steam_22_3_0_0_Windows_Xbox : IIVersion
    {
        ...
        public Steam_22_3_0_0_Windows_Xbox(GameManager gm)
        {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context)
        {
            ...
            {
                if (process.VersionDescription != "22.3.0+1651639")
                {
                    return false;
                }
            }
            ...
            {
                process.VersionDescription = "22.3.0+1651639";
            }
            return true;
#endif
            #endregion
        ...
        {
            // Statics
            public Int64 MainAddress { get { return 0x4E14D60; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x68; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x4D201D8; } } // BA ?? E5 07  At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x4E158B0; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
        ...
        {
            public Int64 Player { get { return 0x47E41C8; } }         // UID: 3796
            public Int64 Staff { get { return 0x47E1728; } }          // UID: 40
            public Int64 PlayerStaff { get { return 0x47E6098; } }    // UID: 103584
            public Int64 HumanManager { get { return 0x47F95B8; } }     // UID: User Manager's
