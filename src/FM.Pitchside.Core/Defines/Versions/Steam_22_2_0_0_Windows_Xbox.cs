...
{
    internal class Steam_22_2_0_0_Windows_Xbox : IIVersion
    {
        ...
        public Steam_22_2_0_0_Windows_Xbox(GameManager gm)
        {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context)
        {
            ...
            {
                if (process.VersionDescription != "22.2.0+1628468")
                {
                    return false;
                }
            }
            ...
            {
                process.VersionDescription = "22.2.0+1628468";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses
        {
            ...
            public Int64 CurrentDateTime { get { return 0x4CCB6E8; } } // BA ?? E5 07  At BaseAddress + offset
