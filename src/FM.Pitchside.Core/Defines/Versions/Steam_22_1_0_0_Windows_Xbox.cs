...
{
    internal class Steam_22_1_0_0_Windows_Xbox : IIVersion
    {
        ...
        public Steam_22_1_0_0_Windows_Xbox(GameManager gm)
        {
        ...
        public string Description
        {
            get
            {
                return "22.1.0 (Windows Xbox Gamepass)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context)
        {
            ...
            {
                if (process.VersionDescription != "22.1.0+1616383")
                {
                    return false;
                }
            }
            ...
            {
                process.VersionDescription = "22.1.0+1616383";
            }
            return true;
#endif
            #endregion
        ...
        {
            // Statics
            public Int64 MainAddress { get { return 0x4DA7830; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x88; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x4CB2718; } } // BA ?? E5 07  At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x4DA8378; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
        ...
        {
            public Int64 Player { get { return 0x4773BF8; } }         // UID: 3796
            public Int64 Staff { get { return 0x4771118; } }          // UID: 40
            public Int64 PlayerStaff { get { return 0x4775AF8; } }    // UID: 103584
            public Int64 HumanManager { get { return 0x4789048; } }     // UID: User Manager's
