...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_22_2_0_0_Windows : IIVersion {
    ...
    public Steam_22_2_0_0_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "22.2.0+1629206") {
          return false;
        }
      }
      else {
        process.VersionDescription = "22.2.0+1629206";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x4CFABE0; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x68; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x4C0E7A8; } } // BA ?? E5 07  At BaseAddress + offset
      public Int64 ActiveObject { get { return 0x4CFB728; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
