...
{
  internal class Steam_22_4_1_0_Windows_Xbox : IIVersion
  {
    ...
    public Steam_22_4_1_0_Windows_Xbox(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "22.4.1+1662587") {
          return false;
        }
      }
      else {
        process.VersionDescription = "22.4.1+1662587";
      }
      return true;
    }
    ...
    {
      // Statics
      public Int64 MainAddress { get { return 0x4E0D7B0; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x68; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x4D16288; } } // BA ?? E5 07  At BaseAddress + offset
      public Int64 ActiveObject { get { return 0x4E0E300; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
