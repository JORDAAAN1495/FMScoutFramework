...
namespace FMScoutFramework.Core.Entities.InGame {
  public class RoleRatings {
    ...
    private byte BestMidfielderCentre() {
      return System.Math.Max(CurrentPlayer.Attributes.MidfielderCenter, CurrentPlayer.Attributes.DefensiveMidfielder);
    }

    private byte BestAttackingMidfielderSide() {
      return System.Math.Max(CurrentPlayer.Attributes.AttackingMidfielderLeft, CurrentPlayer.Attributes.AttackingMidfielderRight);
    }

    private byte BestForwardMidfielderSide() {
      byte bestMrl = System.Math.Max(CurrentPlayer.Attributes.MidfielderLeft, CurrentPlayer.Attributes.MidfielderRight);
      byte bestM = System.Math.Max(bestMrl, CurrentPlayer.Attributes.MidfielderCenter);

      byte bestAMrl = System.Math.Max(CurrentPlayer.Attributes.AttackingMidfielderLeft, CurrentPlayer.Attributes.AttackingMidfielderRight);
    ...
    private byte BestSCSide() {
      return System.Math.Max(CurrentPlayer.Attributes.AttackingMidfielderCenter, CurrentPlayer.Attributes.Striker);
    }
