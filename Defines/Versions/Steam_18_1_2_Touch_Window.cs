...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_1_2_Touch_Windows : IIVersion {
        ...
        public Steam_18_1_2_Touch_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.1.2f1043484") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.1.2f1043484";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x145566E40; } }         // UID: 510
            public Int64 Staff { get { return 0x145561F60; } }          // UID: 4
            public Int64 PlayerStaff { get { return 0x14557C928; } }    // UID: 10090
