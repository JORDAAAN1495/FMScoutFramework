...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_2_1_Windows : IIVersion {
        ...
        public Steam_18_2_1_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.2.1f1051982") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.2.1f1051982";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            // Statics
            public Int64 MainAddress { get { return 0x5C57A00; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x80; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x5AD53F8; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x5D30888; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x14558BBC0; } }         // UID: 510
            public Int64 Staff { get { return 0x145586BB0; } }          // UID: 52
            public Int64 PlayerStaff { get { return 0x1455A7AF0; } }    // UID: 10090
