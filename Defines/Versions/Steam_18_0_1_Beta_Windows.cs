...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_0_1_Beta_Windows : IIVersion {
        ...
        public Steam_18_0_1_Beta_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.0.1b1029274") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.0.1b1029274";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            public Int64 MainAddress { get { return 0x5C0D7B0; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x80; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x5A8C340; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x5CD4958; } } // BaseAddress + offset
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x14554CE60; } }         // UID: 510
            public Int64 Staff { get { return 0x1455481E8; } }          // UID: 52
