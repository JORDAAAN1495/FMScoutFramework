...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_22_4_0_0_Windows_Xbox : IIVersion {
    ...
    public Steam_22_4_0_0_Windows_Xbox(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "22.4.0+1659721") {
          return false;
        }
      }
      else {
        process.VersionDescription = "22.4.0+1659721";
      }
      return true;
    }
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x4E0E7B0; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x68; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x4D17288; } } // BA ?? E5 07  At BaseAddress + offset
      public Int64 ActiveObject { get { return 0x4E0F300; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x47DFC28; } }         // UID: 3796
      public Int64 Staff { get { return 0x47DD188; } }          // UID: 40
      public Int64 PlayerStaff { get { return 0x47E1AF8; } }    // UID: 103584
      public Int64 HumanManager { get { return 0x47F5018; } }     // UID: User Manager's
