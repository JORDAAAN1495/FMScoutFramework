...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_17_3_1_Windows : IIVersion {
        ...
        public Steam_17_3_1_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "17.3.1f939048") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "17.3.1f939048";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            public Int64 MainAddress { get { return 0x39E4280; } }
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x143486228; } }         // UID: 510
            public Int64 Staff { get { return 0x143483F00; } }          // UID: 1
            public Int64 PlayerStaff { get { return 0x1434967E8; } }    // UID: 5025
