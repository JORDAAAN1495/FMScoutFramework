...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_3_3_Windows : IIVersion {
    ...
    public Steam_19_3_3_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.3.3-1202861") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.3.2-1202861";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x692F540; } }
      ...
      public Int64 ActiveObject { get { return 0x6A06AC8; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x629AD58; } }         // UID: 510
      public Int64 Staff { get { return 0x628AB88; } }          // UID: 45
      public Int64 PlayerStaff { get { return 0x6297808; } }    // UID: 104022
      public Int64 HumanManager { get { return 0x628A2C8; } }     // UID: User Manager's
