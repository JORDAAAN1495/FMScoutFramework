...
{
  internal class Steam_21_4_0_Touch_Xbox : IIVersion
  {
    ...
    public Steam_21_4_0_Touch_Xbox(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "21.4.0-1526263") {
          return false;
        }
      }
      else {
        process.VersionDescription = "21.4.0-1526263";
      }
      return true;
#endif
      #endregion
