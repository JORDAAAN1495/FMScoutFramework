...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_1_2_Windows : IIVersion {
        ...
        public Steam_18_1_2_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.1.2f1043463") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.1.2f1043463";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            public Int64 MainAddress { get { return 0x5C429B0; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x80; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x5AC04B0; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x5D1B938; } } // BaseAddress + offset
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x14557DD40; } }         // UID: 510
            public Int64 Staff { get { return 0x145578E28; } }          // UID: 52
            public Int64 PlayerStaff { get { return 0x1455938A8; } }    // UID: 10090
