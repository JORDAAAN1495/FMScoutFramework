...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_0_1_Touch_Windows : IIVersion {
        ...
        public Steam_18_0_1_Touch_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "18.0.1 Touch Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.0.1b1030130") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.0.1b1030130";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x145537F00; } }         // UID: 510
            public Int64 Staff { get { return 0x145533288; } }          // UID: 4
            public Int64 PlayerStaff { get { return 0x145544E18; } }    // UID: 10090
