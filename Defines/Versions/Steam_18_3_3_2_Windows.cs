...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_3_3_2_Windows : IIVersion {
        ...
        public Steam_18_3_3_2_Windows(GameManager gm) {
      ...
      #region WINDOWS
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.3.3f1074698") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.3.3f1074698";
            }
            return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
            // Statics
            public Int64 MainAddress { get { return 0x5C8F1E0; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x88; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x5B0C468; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x5D68138; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x1455C7FD0; } }         // UID: 510
            public Int64 Staff { get { return 0x1455C3118; } }          // UID: 52
            public Int64 PlayerStaff { get { return 0x1455DE4C0; } }    // UID: 10090
