...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_1_0_Touch_Windows : IIVersion {
        ...
        public Steam_18_1_0_Touch_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "18.1.0 Touch Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.1.0f1039812") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.1.0f1039812";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x145563C50; } }         // UID: 510
            public Int64 Staff { get { return 0x14555ED20; } }          // UID: 4
            public Int64 PlayerStaff { get { return 0x145579750; } }    // UID: 10090
