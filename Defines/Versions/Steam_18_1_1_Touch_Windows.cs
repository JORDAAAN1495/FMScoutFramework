...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_1_1_Touch_Windows : IIVersion {
        ...
        public Steam_18_1_1_Touch_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "18.1.1 Touch Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.1.1f1040364") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.1.1f1040364";
            }
            return true;
#endif
            #endregion
