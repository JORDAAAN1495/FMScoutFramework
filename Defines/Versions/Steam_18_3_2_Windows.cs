...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_3_2_Windows : IIVersion {
        ...
        public Steam_18_3_2_Windows(GameManager gm) {
      ...
      #region WINDOWS
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.3.2f1072702") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.3.2f1072702";
            }
            return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
            // Statics
            public Int64 MainAddress { get { return 0x5C90150; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x88; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x5B0D448; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x5D69068; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x1455C8F50; } }         // UID: 510
            public Int64 Staff { get { return 0x1455C4038; } }          // UID: 52
            public Int64 PlayerStaff { get { return 0x1455DEE38; } }    // UID: 10090
