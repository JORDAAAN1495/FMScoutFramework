...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_0_3_Windows : IIVersion {
    ...
    public Steam_19_0_3_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.0.3b1154375") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.0.3b1154375";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x6997A30; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x689A4F8; } } // At BaseAddress + offset
      public Int64 ActiveObject { get { return 0x6A6E788; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x62F8030; } }         // UID: 510
      public Int64 Staff { get { return 0x62E7D50; } }          // UID: 45
      public Int64 PlayerStaff { get { return 0x62F4A80; } }    // UID: 104022
      public Int64 HumanManager { get { return 0x62E7370; } }     // UID: User Manager's
