...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_Touch_17_3_1_Windows : IIVersion {
        ...
        public Steam_Touch_17_3_1_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "17.3.1f952425") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "17.3.1f952425";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x14347D400; } }         // UID: 2906
            public Int64 Staff { get { return 0x14347B0E0; } }          // UID: 53
            public Int64 PlayerStaff { get { return 0x14348D9D0; } }    // UID: 103531
