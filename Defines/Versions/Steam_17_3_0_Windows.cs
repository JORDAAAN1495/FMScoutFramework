...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_17_3_0_Windows : IIVersion {
        ...
        public Steam_17_3_0_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "17.3.0f936783") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "17.3.0f936783";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            public Int64 MainAddress { get { return 0x39E3280; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x80; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x390EE30; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x3A134E0; } } // BaseAddress + offset
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x143485398; } }         // UID: 510
            public Int64 Staff { get { return 0x143483070; } }          // UID: 1
            public Int64 PlayerStaff { get { return 0x143495958; } }    // UID: 5025
        ...
        public class PersonVersionOffsets : IPersonVersionOffsets {
            ...
            public Int64 Player { get { return -0x1D0; } }
