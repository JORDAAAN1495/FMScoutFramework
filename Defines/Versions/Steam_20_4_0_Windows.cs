...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_20_4_0_Windows : IIVersion {
    ...
    public Steam_20_4_0_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "20.4.0-1356331") {
          return false;
        }
      }
      else {
        process.VersionDescription = "20.4.0-1356331";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x7458B10; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x90; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x7350DF0; } } // AF ?? E3 07  At BaseAddress + offset // 68E93A8, 69D17A0, 69D22AC, 69D39F4
      public Int64 ActiveObject { get { return 0x75C5CD0; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x6D62110; } }         // UID: 3796
      public Int64 Staff { get { return 0x6D51118; } }          // UID: 40
      public Int64 PlayerStaff { get { return 0x6D78F10; } }    // UID: 106066
      public Int64 HumanManager { get { return 0x6D50698; } }     // UID: User Manager's
