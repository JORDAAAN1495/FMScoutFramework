...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_2_0_Touch_Windows : IIVersion {
        ...
        public Steam_18_2_0_Touch_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "18.1.2 Touch Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.2.0f1050300") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.2.0f1050300";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            public Int64 MainAddress { get { return 0x5C3DCE0; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x80; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x5ABB438; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x0; } } // BaseAddress + offset
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x145571F38; } }         // UID: 510
            public Int64 Staff { get { return 0x14556CF10; } }          // UID: 4
            public Int64 PlayerStaff { get { return 0x14558E370; } }    // UID: 10090
