...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_1_3_Windows : IIVersion {
        ...
        public Steam_18_1_3_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.1.3f1045020") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.1.3f1045020";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x14557F010; } }         // UID: 510
            public Int64 Staff { get { return 0x14557A110; } }          // UID: 52
            public Int64 PlayerStaff { get { return 0x145594C88; } }    // UID: 10090
