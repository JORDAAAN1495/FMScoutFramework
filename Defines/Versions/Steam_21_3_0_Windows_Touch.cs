...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_21_3_0_Touch_Windows : IIVersion {
    ...
    public Steam_21_3_0_Touch_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "21.3.0-1518085") {
          return false;
        }
      }
      else {
        process.VersionDescription = "21.3.0-1518085";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x6FFA700; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x6EEC798; } } // E3 ?? E4 07 At BaseAddress + offset // 68E93A8, 69D17A0, 69D22AC, 69D39F4
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x68DEC08; } }         // UID: 11133
      public Int64 Staff { get { return 0x68CD188; } }          // UID: 54
      public Int64 PlayerStaff { get { return 0x68F7240; } }    // UID: 107527
      public Int64 HumanManager { get { return 0x68CC680; } }     // UID: User Manager's
    ...
    public class PersonVersionOffsets : IPersonVersionOffsets {
      ...
      public Int64 Player { get { return -0x1C8; } }
