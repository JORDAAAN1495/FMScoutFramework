...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_3_5_1_GamePass_Windows : IIVersion {
    ...
    public Steam_19_3_5_1_GamePass_Windows(GameManager gm) {
    ...
    public string Description {
      get {
        return "19.3.5 XBox GamePas (Windows)";
      }
    }
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      //  if (process.VersionDescription != "19.3.5-1228909") {
      //    return false;
      //  }
      //}
      //else {
      // GamePass executables don't have version description! But since we loaded everything, go ahead
        process.VersionDescription = "19.3.5-1228909";
      //}
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x6A2DC80; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x692B748; } } // B0 ?? E2 07  At BaseAddress + offset // 68E93A8, 69D17A0, 69D22AC, 69D39F4
      public Int64 ActiveObject { get { return 0x6B05D88; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x635FFF8; } }         // UID: 510
      public Int64 Staff { get { return 0x634FE48; } }          // UID: 45
      public Int64 PlayerStaff { get { return 0x635CAC0; } }    // UID: 104022
      public Int64 HumanManager { get { return 0x634F5C8; } }     // UID: User Manager's
