...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_1_5_Windows : IIVersion {
    ...
    public Steam_19_1_5_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.1.5-1166322") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.1.5-1166322";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x69EDE10; } }
      ...
      public Int64 ActiveObject { get { return 0x6AC4CD8; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x6350120; } }         // UID: 510
      public Int64 Staff { get { return 0x633FDE0; } }          // UID: 45
      public Int64 PlayerStaff { get { return 0x634CB80; } }    // UID: 104022
      public Int64 HumanManager { get { return 0x633F3C8; } }     // UID: User Manager's
