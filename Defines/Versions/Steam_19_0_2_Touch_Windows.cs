...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_0_2_Touch_Windows : IIVersion {
    ...
    public Steam_19_0_2_Touch_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.0.2b1151235") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.0.2b1151235";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x62D5188; } }         // UID: 11133
      public Int64 Staff { get { return 0x62C4E70; } }          // UID: 354
      public Int64 PlayerStaff { get { return 0x62EC5C0; } }    // UID: 104062
      public Int64 HumanManager { get { return 0x62C4498; } }     // UID: User Manager's
