...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_3_4_Touch_Windows : IIVersion {
        ...
        public Steam_18_3_4_Touch_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "18.3.4 Touch Steam (Windows)";
            }
        }
      ...
      #region WINDOWS
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.3.4f1094154") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.3.4f1094154";
            }
            return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x1455AE360; } }         // UID: 510
            public Int64 Staff { get { return 0x1455A9430; } }          // UID: 4
            public Int64 PlayerStaff { get { return 0x1455C41D8; } }    // UID: 3339
