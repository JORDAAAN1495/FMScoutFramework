...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_2_1_Touch_Windows : IIVersion {
    ...
    public Steam_19_2_1_Touch_Windows(GameManager gm) {
    ...
    public string Description {
      get {
        return "19.2.0 Touch Steam (Windows)";
      }
    }
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.2.1-1177617") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.2.1-1177617";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x69D59A0; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x68DA308; } } // At BaseAddress + offset (B6 ?? E2 07)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x633B6F0; } }         // UID: 11133
      public Int64 Staff { get { return 0x632B718; } }          // UID: 354
      public Int64 PlayerStaff { get { return 0x6352AD0; } }    // UID: 104062
      public Int64 HumanManager { get { return 0x632AD58; } }     // UID: User Manager's
