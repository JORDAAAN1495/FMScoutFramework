...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_2_2_Touch_Windows : IIVersion {
    ...
    public Steam_19_2_2_Touch_Windows(GameManager gm) {
    ...
    public string Description {
      get {
        return "19.2.2 Touch Steam (Windows)";
      }
    }
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.2.2-1184738") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.2.2-1184738";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x68A46D0; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x67A8798; } } // At BaseAddress + offset (B6 ?? E2 07)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x6218E10; } }         // UID: 11133
      public Int64 Staff { get { return 0x6208E38; } }          // UID: 354
      public Int64 PlayerStaff { get { return 0x622FD68; } }    // UID: 104062
      public Int64 HumanManager { get { return 0x6208578; } }     // UID: User Manager's
