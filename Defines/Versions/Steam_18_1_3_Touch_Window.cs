...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_1_3_Touch_Windows : IIVersion {
        ...
        public Steam_18_1_3_Touch_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.1.3f1045048") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.1.3f1045048";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x1455670C8; } }         // UID: 510
            public Int64 Staff { get { return 0x1455621B8; } }          // UID: 4
            public Int64 PlayerStaff { get { return 0x14557CCB8; } }    // UID: 10090
