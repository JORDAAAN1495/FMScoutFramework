...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_3_6_Windows : IIVersion {
    ...
    public Steam_19_3_6_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.3.6-1242975") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.3.6-1242975";
      }
      return true;
#endif
      #endregion
