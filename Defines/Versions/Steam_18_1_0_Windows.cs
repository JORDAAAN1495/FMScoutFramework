...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_1_0_Windows : IIVersion {
        ...
        public Steam_18_1_0_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.1.0f1039737") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.1.0f1039737";
            }
            return true;
#endif
            #endregion
