...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_2_0_Touch_Windows : IIVersion {
    ...
    public Steam_19_2_0_Touch_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.2.0-1173340") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.2.0-1173340";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x69D3980; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x68D82F8; } } // At BaseAddress + offset (B6 ?? E2 07)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x6339750; } }         // UID: 11133
      public Int64 Staff { get { return 0x63295E0; } }          // UID: 354
      public Int64 PlayerStaff { get { return 0x6350A58; } }    // UID: 104062
      public Int64 HumanManager { get { return 0x6328D28; } }     // UID: User Manager's
