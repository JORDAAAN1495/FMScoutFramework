...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_1_1_Touch_Windows : IIVersion {
    ...
    public Steam_19_1_1_Touch_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.1.1rc1159630") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.1.1rc1159630";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x69C6FE0; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x68CB3A8; } } // At BaseAddress + offset (B6 ?? E2 07)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x632A300; } }         // UID: 11133
      public Int64 Staff { get { return 0x6319EA0; } }          // UID: 354
      public Int64 PlayerStaff { get { return 0x6342010; } }    // UID: 104062
      public Int64 HumanManager { get { return 0x63195D0; } }     // UID: User Manager's
