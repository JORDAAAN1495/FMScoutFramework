...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_0_2_Windows : IIVersion {
        ...
        public Steam_18_0_2_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.0.2b1032507") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.0.2b1032507";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x145550F88; } }         // UID: 510
            public Int64 Staff { get { return 0x14554C2C0; } }          // UID: 52
            public Int64 PlayerStaff { get { return 0x145566C88; } }    // UID: 10090
