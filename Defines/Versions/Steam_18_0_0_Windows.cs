...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_0_0_Windows : IIVersion {
        ...
        public Steam_18_0_0_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.0.0d1021188") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.0.0d1021188";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x1455263C8; } }         // UID: 510
            public Int64 Staff { get { return 0x145521650; } }          // UID: 1
            public Int64 PlayerStaff { get { return 0x14553B9F8; } }    // UID: 5025
