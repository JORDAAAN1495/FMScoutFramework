...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_21_0_0_Windows : IIVersion {
    ...
    public Steam_21_0_0_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "21.0.0-1474539") {
          return false;
        }
      }
      else {
        process.VersionDescription = "21.0.0-1474539";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x6F54AD0; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x6E4C338; } } // D1 ?? E4 07  At BaseAddress + offset // 68E93A8, 69D17A0, 69D22AC, 69D39F4
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x683D3D8; } }         // UID: 3796
      public Int64 Staff { get { return 0x682AE20; } }          // UID: 40
      public Int64 PlayerStaff { get { return 0x6855550; } }    // UID: 106066
      public Int64 HumanManager { get { return 0x682A360; } }     // UID: User Manager's
