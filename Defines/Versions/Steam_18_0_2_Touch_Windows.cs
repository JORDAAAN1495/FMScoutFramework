...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_0_2_Touch_Windows : IIVersion {
        ...
        public Steam_18_0_2_Touch_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "18.0.2 Touch Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.0.2b1033050") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.0.2b1033050";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x1455390F0; } }         // UID: 510
            public Int64 Staff { get { return 0x145534420; } }          // UID: 4
