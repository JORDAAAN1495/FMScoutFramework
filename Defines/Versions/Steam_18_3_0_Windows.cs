...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_3_0_Windows : IIVersion {
        ...
        public Steam_18_3_0_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.3.0f1069563") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.3.0f1069563";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            // Statics
            public Int64 MainAddress { get { return 0x5C8F1F0; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x88; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x5B0C428; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x5D68098; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x1455C6EC0; } }         // UID: 510
            public Int64 Staff { get { return 0x1455C2020; } }          // UID: 52
            public Int64 PlayerStaff { get { return 0x1455DD318; } }    // UID: 10090
