...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_3_5_Windows : IIVersion {
    ...
    public Steam_19_3_5_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.3.5-1225655") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.3.5-1225655";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x6299D98; } }         // UID: 510
      public Int64 Staff { get { return 0x6289D40; } }          // UID: 45
      public Int64 PlayerStaff { get { return 0x6296878; } }    // UID: 104022
      public Int64 HumanManager { get { return 0x6289340; } }     // UID: User Manager's
