...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_Touch_17_3_2_Windows : IIVersion {
        ...
        public Steam_Touch_17_3_2_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "17.3.1 Touch Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "17.3.2f971128") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "17.3.2f971128";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            ...
            public Int64 CurrentDateTime { get { return 0x3906E30; } } // At BaseAddress + offset
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x14347D310; } }         // UID: 2906
            public Int64 Staff { get { return 0x14347AFF0; } }          // UID: 53
            public Int64 PlayerStaff { get { return 0x14348D8C8; } }    // UID: 103531
