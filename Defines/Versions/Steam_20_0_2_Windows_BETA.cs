...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_20_0_2_Windows : IIVersion {
    ...
    public Steam_20_0_2_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "20.0.2-1305244") {
          return false;
        }
      }
      else {
        process.VersionDescription = "20.0.2-1305244";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x7455180; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x7348FA0; } } // AF ?? E3 07  At BaseAddress + offset // 68E93A8, 69D17A0, 69D22AC, 69D39F4
      public Int64 ActiveObject { get { return 0x75BD170; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x6D63DD8; } }         // UID: 3796
      public Int64 Staff { get { return 0x6D52318; } }          // UID: 40
      public Int64 PlayerStaff { get { return 0x6D60E10; } }    // UID: 104022
      public Int64 HumanManager { get { return 0x6D51AA8; } }     // UID: User Manager's
