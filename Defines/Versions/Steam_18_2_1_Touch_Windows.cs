...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_2_1_Touch_Windows : IIVersion {
        ...
        public Steam_18_2_1_Touch_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "18.2.1 Touch Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.2.1f1052003") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.2.1f1052003";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x145571D38; } }         // UID: 510
            public Int64 Staff { get { return 0x14556CD18; } }          // UID: 4
            public Int64 PlayerStaff { get { return 0x14558DBF8; } }    // UID: 3339
