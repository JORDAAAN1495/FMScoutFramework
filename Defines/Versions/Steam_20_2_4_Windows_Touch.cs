...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_20_2_4_Touch_Windows : IIVersion {
    ...
    public Steam_20_2_4_Touch_Windows(GameManager gm) {
    ...
    public string Description {
      get {
        return "20.2.4 Touch Steam (Windows)";
      }
    }
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "20.2.4-1343694") {
          return false;
        }
      }
      else {
        process.VersionDescription = "20.2.4-1343694";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x7458C90; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x7352DB8; } } // B6 ?? E3 07  At BaseAddress + offset // 68E93A8, 69D17A0, 69D22AC, 69D39F4
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x6D72530; } }         // UID: 11133
      public Int64 Staff { get { return 0x6D61760; } }          // UID: 168
      public Int64 PlayerStaff { get { return 0x6D89C18; } }    // UID: 108241
      public Int64 HumanManager { get { return 0x6D60EB8; } }     // UID: User Manager's
