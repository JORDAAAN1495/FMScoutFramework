...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_Touch_17_3_0_Windows : IIVersion {
        ...
        public Steam_Touch_17_3_0_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "17.3.0 Touch Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "17.3.0f936814") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "17.3.0f936814";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x14347D438; } }         // UID: 2906
            public Int64 Staff { get { return 0x14347B100; } }          // UID: 53
            public Int64 PlayerStaff { get { return 0x14348D9F0; } }    // UID: 103531
