...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_3_3_Windows : IIVersion {
        ...
        public Steam_18_3_3_Windows(GameManager gm) {
      ...
      #region WINDOWS
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.3.3f1074310") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.3.3f1074310";
            }
            return true;
#endif
      #endregion
