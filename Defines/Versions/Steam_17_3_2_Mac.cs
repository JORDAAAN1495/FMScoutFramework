...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_17_3_2_Mac : IIVersion {
        ...
        public Steam_17_3_2_Mac(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context)
        {
            ...
            FMCore.logger.LogWrite("In-game date correct! Version is a match.");
            process.VersionDescription = "17.3.2f971572";
            return true;
#endif
            #endregion
        }
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x107C44040; } }         // UID: 510
            public Int64 Staff { get { return 0x107C3CB68; } }          // UID: 1
            public Int64 PlayerStaff { get { return 0x107C4A3C8; } }    // UID: 5025
