...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_22_1_1_0_Windows_Xbox : IIVersion {
    ...
    public Steam_22_1_1_0_Windows_Xbox(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "22.1.1+1620793") {
          return false;
        }
      }
      else {
        process.VersionDescription = "22.1.1+1620793";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x4DA7850; } }
      ...
      public Int64 ActiveObject { get { return 0x4DA8398; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
