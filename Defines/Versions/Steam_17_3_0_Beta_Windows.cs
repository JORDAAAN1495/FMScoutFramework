...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_17_3_0_Beta_Windows : IIVersion {
        ...
        public Steam_17_3_0_Beta_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "17.3.0 Beta Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "17.3.0f930319") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "17.3.0f930319";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            public Int64 MainAddress { get { return 0x39D5CA0; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x80; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x3901E10; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x3A0E850; } } // BaseAddress + offset
