...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_3_4_Windows : IIVersion {
        ...
        public Steam_18_3_4_Windows(GameManager gm) {
      ...
      #region WINDOWS
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.3.4f1093856") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.3.4f1093856";
            }
            return true;
#endif
      #endregion
