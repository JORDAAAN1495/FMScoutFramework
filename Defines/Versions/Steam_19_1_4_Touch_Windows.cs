...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_1_4_Touch_Windows : IIVersion {
    ...
    public Steam_19_1_4_Touch_Windows(GameManager gm) {
    ...
    public string Description {
      get {
        return "19.1.4 Touch Steam (Windows)";
      }
    }
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.1.4-1164394") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.1.4-1164394";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x69CCEA0; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x68D1358; } } // At BaseAddress + offset (B6 ?? E2 07)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x63305E0; } }         // UID: 11133
      public Int64 Staff { get { return 0x63202B0; } }          // UID: 354
      public Int64 PlayerStaff { get { return 0x6348298; } }    // UID: 104062
      public Int64 HumanManager { get { return 0x631F898; } }     // UID: User Manager's
