...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_0_3_Touch_Windows : IIVersion {
        ...
        public Steam_18_0_3_Touch_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "18.0.3 Touch Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.0.3b1036199") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.0.3b1036199";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x145564CD8; } }         // UID: 510
            public Int64 Staff { get { return 0x14555FFE0; } }          // UID: 4
            public Int64 PlayerStaff { get { return 0x14557A9A8; } }    // UID: 10090
