...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_2_2_Touch_Windows : IIVersion {
        ...
        public Steam_18_2_2_Touch_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "18.2.2 Touch Steam (Windows)";
            }
        }
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.2.2f1056195") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.2.2f1056195";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x145572C68; } }         // UID: 510
            public Int64 Staff { get { return 0x14556DCA0; } }          // UID: 4
            public Int64 PlayerStaff { get { return 0x14558F0E8; } }    // UID: 3339
