...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class GamePass_20_4_1_Windows : IIVersion {
    ...
    public GamePass_20_4_1_Windows(GameManager gm) {
    ...
    public string Description {
      get {
        return "20.4.1 GamePass (Windows)";
      }
    }
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "20.4.1-1419207") {
          return false;
        }
      }
      else {
        process.VersionDescription = "20.4.1-1419207";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x7566340; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x90; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x7453FD0; } } // AF ?? E3 07  At BaseAddress + offset // 68E93A8, 69D17A0, 69D22AC, 69D39F4
      public Int64 ActiveObject { get { return 0x76D32F0; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x6E40348; } }         // UID: 3796
      public Int64 Staff { get { return 0x6E2F370; } }          // UID: 40
      public Int64 PlayerStaff { get { return 0x6E57080; } }    // UID: 106066
      public Int64 HumanManager { get { return 0x6E2E8F0; } }     // UID: User Manager's
