...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_1_4_Windows : IIVersion {
    ...
    public Steam_19_1_4_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.1.4-1164389") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.1.4-1164389";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      ...
      public Int64 ActiveObject { get { return 0x6AC4D28; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x634FE58; } }         // UID: 510
      public Int64 Staff { get { return 0x633FB28; } }          // UID: 45
      public Int64 PlayerStaff { get { return 0x634C8B8; } }    // UID: 104022
      public Int64 HumanManager { get { return 0x633F118; } }     // UID: User Manager's
