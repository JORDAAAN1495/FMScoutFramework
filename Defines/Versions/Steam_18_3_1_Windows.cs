...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_3_1_Windows : IIVersion {
        ...
        public Steam_18_3_1_Windows(GameManager gm) {
      ...
      #region WINDOWS
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.3.1f1071766") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.3.1f1071766";
            }
            return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
            // Statics
            public Int64 MainAddress { get { return 0x5C900E0; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x88; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x5B0D468; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x5D68FA8; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x1455C8CC8; } }         // UID: 510
            public Int64 Staff { get { return 0x1455C3D60; } }          // UID: 52
            public Int64 PlayerStaff { get { return 0x1455DF0A8; } }    // UID: 10090
