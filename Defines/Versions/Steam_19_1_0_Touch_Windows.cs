...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_1_0_Touch_Windows : IIVersion {
    ...
    public Steam_19_1_0_Touch_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.1.0b1157754") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.1.0b1157754";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x69C3E80; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x68C8398; } } // At BaseAddress + offset (B6 ?? E2 07)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x6326E28; } }         // UID: 11133
      public Int64 Staff { get { return 0x6316A20; } }          // UID: 354
      public Int64 PlayerStaff { get { return 0x633EBB0; } }    // UID: 104062
      public Int64 HumanManager { get { return 0x6316150; } }     // UID: User Manager's
