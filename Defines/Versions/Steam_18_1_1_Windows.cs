...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_1_1_Windows : IIVersion {
        ...
        public Steam_18_1_1_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.1.1f1040315") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.1.1f1040315";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            public Int64 MainAddress { get { return 0x5C3F950; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x80; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x5ABD460; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x5D18868; } } // BaseAddress + offset
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x14557BC58; } }         // UID: 510
            public Int64 Staff { get { return 0x145576D58; } }          // UID: 52
            public Int64 PlayerStaff { get { return 0x1455917E0; } }    // UID: 10090
