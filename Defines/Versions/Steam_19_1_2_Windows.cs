...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_1_2_Windows : IIVersion {
    ...
    public Steam_19_1_2_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.1.2rc1161578") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.1.2rc1161578";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
      // Statics
      public Int64 MainAddress { get { return 0x69EAF50; } }
      public Int64 MainOffset { get { return 0x0; } }
      public Int64 XorDistance { get { return 0x88; } }
      public Int64 StringOffset { get { return 0x0; } }
      public Int64 CurrentDateTime { get { return 0x68EF338; } } // B0 ?? E2 07  At BaseAddress + offset // 68E93A8, 69D17A0, 69D22AC, 69D39F4
      public Int64 ActiveObject { get { return 0x6AC1E58; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x634DC30; } }         // UID: 510
      public Int64 Staff { get { return 0x633D8D8; } }          // UID: 45
      public Int64 PlayerStaff { get { return 0x634A670; } }    // UID: 104022
      public Int64 HumanManager { get { return 0x633CEC0; } }     // UID: User Manager's
