...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_3_3_Touch_Windows : IIVersion {
        ...
        public Steam_18_3_3_Touch_Windows(GameManager gm) {
        ...
        public string Description {
            get {
                return "18.3.3 Touch Steam (Windows)";
            }
        }
      ...
      #region WINDOWS
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.3.3f1077767") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.3.3f1077767";
            }
            return true;
#endif
      #endregion
    ...
    public class VersionMemoryAddresses : IVersionMemoryAddresses {
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x1455ABE90; } }         // UID: 510
            public Int64 Staff { get { return 0x1455A6FF0; } }          // UID: 4
            public Int64 PlayerStaff { get { return 0x1455C22F0; } }    // UID: 3339
