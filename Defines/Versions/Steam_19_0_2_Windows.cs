...
namespace FMScoutFramework.Core.Entities.GameVersions {
  internal class Steam_19_0_2_Windows : IIVersion {
    ...
    public Steam_19_0_2_Windows(GameManager gm) {
    ...
    public bool SupportsProcess(FMProcess process, byte[] context) {
      ...
      if (!string.IsNullOrEmpty(process.VersionDescription)) {
        if (process.VersionDescription != "19.0.2b1151251") {
          return false;
        }
      }
      else {
        process.VersionDescription = "19.0.2b1151251";
      }
      return true;
#endif
      #endregion
    ...
    public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
      public Int64 Player { get { return 0x62F5E00; } }         // UID: 510
      public Int64 Staff { get { return 0x62E5AF8; } }          // UID: 45
      public Int64 PlayerStaff { get { return 0x62F2830; } }    // UID: 104022
      public Int64 HumanManager { get { return 0x62E50E8; } }     // UID: User Manager's
