...
namespace FMScoutFramework.Core.Entities.GameVersions {
    internal class Steam_18_2_2_Windows : IIVersion {
        ...
        public Steam_18_2_2_Windows(GameManager gm) {
        ...
        public bool SupportsProcess(FMProcess process, byte[] context) {
            ...
            if (!string.IsNullOrEmpty(process.VersionDescription)) {
                if (process.VersionDescription != "18.2.2f1055984") {
                    return false;
                }
            }
            else {
                process.VersionDescription = "18.2.2f1055984";
            }
            return true;
#endif
            #endregion
        ...
        public class VersionMemoryAddresses : IVersionMemoryAddresses {
            // Statics
            public Int64 MainAddress { get { return 0x5C57A20; } }
            public Int64 MainOffset { get { return 0x0; } }
            public Int64 XorDistance { get { return 0x80; } }
            public Int64 StringOffset { get { return 0x0; } }
            public Int64 CurrentDateTime { get { return 0x5AD53E8; } } // At BaseAddress + offset
            public Int64 ActiveObject { get { return 0x5D308D8; } } // BaseAddress + offset (ID: 5640119 / B7 0F 56 00)
        ...
        public class VersionPersonEnumPointers : IVersionPersonEnumPointers {
            public Int64 Player { get { return 0x14558BDA8; } }         // UID: 510
            public Int64 Staff { get { return 0x145586DE0; } }          // UID: 52
            public Int64 PlayerStaff { get { return 0x1455A82B0; } }    // UID: 10090
